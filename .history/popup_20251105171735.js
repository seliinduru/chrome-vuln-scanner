// popup.js - CSP UYUMLU, TAM VE HATALARDAN ARINDIRILMIŞ VERSİYON
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const ScoreCalculator = {
        calculateScore: (vuln, config, modelName) => {
            ...
            // Her model için formülleri manuel olarak uygula (eval YOK)
            if (modelName === 'gemini') {
    ...
    // Fuzzy logic motoru CSP uyumludur, bu yüzden aynı kalabilir.
    const FuzzyLogicEngine = {
        evaluate: (vuln, config) => {
            ...
            // Bu motorun basitleştirilmiş bir versiyonu, ana mantığı korur
            rules.forEach(rule => {
