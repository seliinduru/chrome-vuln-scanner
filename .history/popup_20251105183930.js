// popup.js - NİHAİ, TEK SAYFA UYGULAMASI MİMARİSİNE SAHİP SON VERSİYON
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Skorlama ve Değerlendirme Motorları (Değişiklik yok)
    ...
    document.querySelectorAll('.tab').forEach(tab => {
        tab.addEventListener('click', (e) => {
            ...
            // Ayarlar sekmesi ayrı bir sayfaya yönlendirir
            if (targetTabId === 'settings') {
                window.location.href = 'settings.html';
                return; 
            }

            // Diğer sekmeler için içeriği göster/gizle
            document.querySelector('.tab.active')?.classList.remove('active');
            document.querySelector('.tab-content.active')?.classList.remove('active');
            e.target.classList.add('active');
            document.getElementById(targetTabId)?.classList.add('active');

            // Eğer tıklanan sekme AI ise, önerileri o anda oluştur
            if (targetTabId === 'ai') {
