...
// Popup veya background'tan gelen scanPage/checkStatus komutunu dinle (İletişim hatası düzeltildi)
...
chrome.storage.local.get('scanOnPageLoad', (result) => {
  if (result.scanOnPageLoad) {
    ...
    // scanPage(); // Pop-up'ın tetiklemesini beklemek daha güvenlidir.
  }
});