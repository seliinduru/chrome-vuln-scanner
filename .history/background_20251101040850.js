...
let lastScanTimestamp = null; // Tarama zaman damgası
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  try {
    ...
    if (message.action === 'vulnerabilitiesDetected') {
      ...
      lastScanTimestamp = Date.now(); // Zaman damgasını kaydet
    ...
    if (message.action === 'getVulns') {
      ...
      sendResponse({ 
        ...
        timestamp: lastScanTimestamp // Zaman damgasını da gönder
      });
      return true;
    }
