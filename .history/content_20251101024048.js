...
function addVuln(id, title, details, type, severity = 'medium', evidence = null, location = 'inline', matchCount = 1, contextFactors = false, userInteraction = false, externalFactors = false) {
  // HATA ÇÖZÜMÜ: Aşırı Güvenli (Defensive) kodlama. location'ın null/undefined gelme ihtimaline karşı tekrar kontrol.
  ...
  vulnerabilities.push({ 
    ...
    type: type || 'other', 
    severity: severity || 'medium', // Güvenlik önlemi
    evidence,
    // Scoring inputs - Tüm değerleri olası undefined/null durumuna karşı kontrol et
