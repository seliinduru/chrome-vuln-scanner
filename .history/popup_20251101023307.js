...
// DOM Elementleri
const statusText = document.getElementById('statusText'); // Hata Çözümü: Global element referansı
...
function showVulnDetails(vuln) {
    ...
    // ... (Detay bölümü oluşturma ve doldurma kodu aynı kalır)
      ...
      chrome.tabs.query({ active: true, currentWindow: true }, async (tabs) => {
        ...
        const sendMessageAndHandleError = () => {
          ...
          const timeoutId = setTimeout(() => {
              // Hata Çözümü: statusText'i DOM'dan tekrar çekerek kontrol et
