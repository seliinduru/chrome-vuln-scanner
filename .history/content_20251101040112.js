...
(function() {
    ...
    if (window.CONTENT_SCRIPT_RUNNING) {
        // Zaten çalışıyorsa, sadece checkStatus yanıtını vermeliyiz.
        // Ancak daha temiz olması için sadece kontrol bayrağını tutuyoruz
        // ve ana dinleyiciyi bir kez kuruyoruz.
        return; 
    }
    ...
    chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
      ...
      // DİKKAT: Diğer koşullar için sendResponse çağrılmadığından return true YOK
    });
