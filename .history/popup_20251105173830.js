// popup.js - EN SAĞLAM VE HATAYA DAYANIKLI SON VERSİYON
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const renderVulns = () => {
        ...
        if (!fuzzyLogicConfig || !scoreMethods) {
            ...
            vulnList.innerHTML = `<div class="empty-state"><p>Arka plan betiğinde bir hata oluştu. Lütfen uzantı yöneticisinden 'Service Worker' konsolunu kontrol edin.</p></div>`;
            return;
        }
